...
public sealed partial class NewsReaderUiFragment : BoxContainer
{
    ...
    public void UpdateState(NewsArticle article, int targetNum, int totalNum, bool notificationOn)
    {
        ...
        PageText.SetMessage(FormattedMessage.FromMarkupPermissive(article.Content), /* SS220 Safe markup tags */ RichTextHelper.SafeMarkupTags );
        ...
        Author.SetMessage(FormattedMessage.FromMarkupPermissive(author), /* SS220 Safe markup tags */ RichTextHelper.SafeMarkupTags);
