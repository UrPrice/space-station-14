...
public sealed partial class PhotocopierWindow : FancyWindow
{
    ...
    public PhotocopierWindow()
    {
        ...
        _experienceSystem = _sysMan.GetEntitySystem<ExperienceSystem>();
    ...
    private TreeItem? AddEntry(TreeItem? parent, FormGroup group, string collectionId, TreeItem? useAsEntry = null)
    {
        ...
        {
            var title = _playerManager.LocalEntity is null || _experienceSystem.HaveSkill(_playerManager.LocalEntity.Value, SkillToUnderstandFormNames)
                        ? form.Value.PhotocopierTitle
    ...
    private void AddEntry(TreeItem? parent, Form entry, FormDescriptor descriptor)
    {
        ...
        item.Label.Text = _playerManager.LocalEntity is null || _experienceSystem.HaveSkill(_playerManager.LocalEntity.Value, SkillToUnderstandFormNames)
                        ? entry.PhotocopierTitle
                        : entry.EntityName;
