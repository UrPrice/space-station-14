...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly ExperienceViewerUIController _experience = default!; // SS220-experience-update
    ...
    public void UnloadButtons()
    {
        ...
        _experience.UnloadButton(); // SS220-experience-update
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _experience.LoadButton(); // SS220-experience-update
    }
}
