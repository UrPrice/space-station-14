...
public sealed partial class BanPanel : DefaultWindow
{
    ...
    [Dependency] private readonly SharedGameTicker _gameTicker = default!; // SS220-add-round-id-to-ban
    ...
    public BanPanel()
    {
        ...
        Tabs.SetTabTitle((int)TabNumbers.Species, Loc.GetString("ban-panel-tabs-species"));
    ...
    // SS220 Species bans begin
    private const string SpeciesCheckboxNamePrefix = "SpeciesCheckbox";

    private void AddSpeciesCheckbox(SpeciesPrototype species)
    {
        ...
        _speciesCheckboxes.Add(checkbox);
