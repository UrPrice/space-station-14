...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        private void HandleToggleTryToPickUpStorageInSuitContainerCheckbox(BaseButton.ButtonToggledEventArgs args)
        {
            _cfg.SetCVar(CCVars220.TryToPickUpStorageInSuitContainer, args.Pressed);
            _cfg.SaveToFile();
        }
        ...
        public KeyRebindTab()
        {
            ...
            AddCheckBox("ui-options-smart-equip-pickup-suitstorge", _cfg.GetCVar(CCVars220.TryToPickUpStorageInSuitContainer), HandleToggleTryToPickUpStorageInSuitContainerCheckbox); // SS220 Better-smart-equip
            ...
            AddButton(KeyFunctions220.OpenExperienceViewerMenu); // SS220-experience-update
