...
ent-MobMoproach = швабракан
    .desc = Милый швабракан с ещё более милыми тапочками-швабрами на лапках.
...
ent-MobBaseKobold = кобольд
    .desc = Двоюродные братья разумного вида рептилий, кобольды сливаются со своей естественной средой обитания, и так же противны, как обезьяны. Они готовы вырвать ваши волосы и заколоть вас до смерти.
...
ent-MobGiantSpiderWizard = паук-волшебник
    ...
    .suffix = Волшебник
ent-MobSpiderGhostWizard = волшебный паучий призрак
    .desc = Этот паучий призрак выглядит немного волшебным.
    .suffix = Волшебник
