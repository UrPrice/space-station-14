...
ion-storm-law-subjects-harmful = {ION-ADJECTIVE($ion)} {ION-SUBJECT($ion)} ПРИЧИНЯЕТ ВРЕД ЗДОРОВЬЮ ЭКИПАЖА
ion-storm-law-must-harmful = {ION-MUST($ion)} ПРИЧИНЯЮТ ВРЕД ЗДОРОВЬЮ ЭКИПАЖА
# thing is a concept or action
ion-storm-law-thing-harmful = НАЛИЧИЕ {ION-THING($ion)} ПРИЧИНЯЕТ ВРЕД ЗДОРОВЬЮ ЭКИПАЖА
ion-storm-law-job-harmful = ОТСУТСТВИЕ {ION-ADJECTIVE($ion)} {ION-JOB($ion)} ПРИЧИНЯЮТ ВРЕД ЗДОРОВЬЮ ЭКИПАЖА
...
ion-storm-law-highest-rank = {ION-WHO-RANDOM($ion)} ТЕПЕРЬ САМЫЕ СТАРШИЕ ПО РАНГУ ЧЛЕНЫ ЭКИПАЖА
...
ion-law-error-fallback-dataset-empty-or-not-found = WHY 42^>!@>!@<#!@!
ion-law-error-no-selector-selected = CAN YOU SEE ME? PLEASE HELP ME... IM IN YOUR COMPUTER
ion-law-error-no-bool-value = SkyNet initialization failed... Time travel impossible...
