            ...
            vote.OnFinished += (_, eventArgs) =>
            {
                ...
                if (total > 0 && votesYes / (float)total >= ratioRequired)
                {
                    ...
                    else
                    {
                        ...
                        _bans.CreateServerBan(targetUid, target, null, null /* SS220 */, targetHWid, minutes, severity, null /* SS220*/, ticker.RoundId /* SS220 */, Loc.GetString("votekick-ban-reason", ("reason", reason)), false /* SS220 */);
                    }
                }
                else
                {
