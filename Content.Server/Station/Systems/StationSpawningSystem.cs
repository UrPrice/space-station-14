...
public sealed class PlayerSpawningEvent : EntityEventArgs
{
    ...
    public readonly bool AllowLatejoinSpawnpoints = true;

    public PlayerSpawningEvent(ProtoId<JobPrototype>? job, HumanoidCharacterProfile? humanoidCharacterProfile, EntityUid? station, bool allowLatejoinSpawnpoints = true)
    {
        Job = job;
        HumanoidCharacterProfile = humanoidCharacterProfile;
        Station = station;
        AllowLatejoinSpawnpoints = allowLatejoinSpawnpoints; //SS220 deathmatch-no-latejoin-spawnpoints
    }
}
