...
public sealed class LimitedEquipSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<LimitedEquipComponent, GotUnequippedEvent>(OnGotUnequipped);
    }

    private void OnGotUnequipped(Entity<LimitedEquipComponent> uid, ref GotUnequippedEvent args)
    {
