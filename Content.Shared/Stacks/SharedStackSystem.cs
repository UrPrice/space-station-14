...
namespace Content.Shared.Stacks
{
    ...
    public abstract class SharedStackSystem : EntitySystem
    {
        ...
        private void OnStackAlternativeInteract(EntityUid uid, StackComponent stack, GetVerbsEvent<AlternativeVerb> args)
        {
            ...
            var customAmount = MakeCustomVerb(args.User, (uid, stack), "custom-amount-title", "custom-amount-prompt");

            if (customAmount is not null)
        ...
        // SS220-make-custom-amount-verb-begin
        protected virtual AlternativeVerb? MakeCustomVerb(EntityUid user, Entity<StackComponent> stackEntity, LocId title, LocId prompt)
        {
            return null;
        }
        // SS220-make-custom-amount-verb-end
